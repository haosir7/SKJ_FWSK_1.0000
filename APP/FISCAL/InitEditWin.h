...
#ifndef INIT_EDIT_WIN_H
#define INIT_EDIT_WIN_H
 ...
 *@brief 款机初始化界面
 */
class CInitEditWin : public CaWindow
{
public:
	...
	string m_OldCertfPsw;						/**< 旧证书口令*/
	string m_NewCertfPsw;						/**< 新证书口令*/

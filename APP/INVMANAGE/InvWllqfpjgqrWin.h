...
#ifndef _INV_WLLQFPJGQR_WIN_H
#define _INV_WLLQFPJGQR_WIN_H
...
/**
 *@class CInvWllqfpjgqrWin 
 *@brief 网络领取发票结果确认界面
 */
class CInvWllqfpjgqrWin : public CaWindow
{
public:

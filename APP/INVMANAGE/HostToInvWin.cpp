...
void CHostToInvWin::OnButton1(int iEvent, unsigned char * pEventData, int iDataLen)
{
	...
	CaMsgBox msgBox("是否为分机分配发票？", CaMsgBox::MB_YESNO);
	msgBox.ShowBox();

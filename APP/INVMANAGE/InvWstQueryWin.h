...
#ifndef INV_WST_QUERY_WIN_H
#define INV_WST_QUERY_WIN_H
...
/**
 *@class CInvWstQueryWin 
 *@brief 发票管理档的可作废发票存根查询界面
 */
class CInvWstQueryWin : public CaWindow
{
public:

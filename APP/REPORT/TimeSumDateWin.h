...
#ifndef TIME_SUM_DATE_WIN_H
#define TIME_SUM_DATE_WIN_H
...
/**
 *@class CTimeSumDateWin 
 *@brief 报表打印的时间段汇总 时间输入界面
 */
class CTimeSumDateWin : public CaWindow
{
public:
...
public:
	...
	*/
	...
	//UINT8 PrnTimeSaleSumProc();

//	UINT8 TimeSaleSumHandle();
